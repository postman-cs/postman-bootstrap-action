...
const CONFIG: RepoConfig = {"pkgName":"@postman/onboarding-bootstrap","binName":"postman-bootstrap","pkgMain":"dist/index.cjs","actionMain":"dist/action.cjs","census":["action.cjs","cli.cjs","index.cjs"]};
