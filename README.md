...
| `sync-generated-assets` | Whether to create or update generated collections and curated collection assets. Set false for workspace/spec-only onboarding. | no | `true` |
